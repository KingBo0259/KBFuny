...
- (void)viewDidLoad {
    ...
    self.titles=@[@"模态/遮罩/边框/粒子效果",@"Mask",@"UIBezierPath",@"类似淘宝购物车",@"Uber首页动画"];
    
    self.detailControllers=@[@"KBShaperLayerController",@"KBShaperLayerDemoViewController",@"UIBezierPathViewController",@"KBShoppingCartController",@"KBUberImitateViewController"];
